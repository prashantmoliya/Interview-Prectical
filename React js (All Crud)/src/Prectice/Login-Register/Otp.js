...
const Otp = () => {
    ...
    const [getotp, setgetotp] = useState(Number);

    const GetOtp = () => {
        const getdata = JSON.parse(localStorage.getItem('Otp-User'));
        
        console.log('Otp-Get++', getdata);
                    ...
                    <div className="authentication-inner py-4">
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="mb-4">
                                    <span>We have sent the OTP code to your email-id <div style={{ display: 'inline', color: '#000000' }}>{getotp.email}</div> . Enter that OTP code.</span>
                                </div>
                                <form className="mb-3">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter your otp" value={otp} onChange={(e) => setotp(parseInt(e.target.value))} />
                                    </div>
                                    <button type="button" className="btn btn-primary d-grid w-100" onClick={HandleVerify}>Verify</button>
                                </form>
                            </div>
                        </div>
                        {/* /Forgot Password */}

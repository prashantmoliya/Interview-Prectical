...
const Register = () => {
    ...
    const HandleSignup = (e) => {
        ...
        if (password === cpassword) {
            ...
            const add= [...data, register];
            localStorage.setItem('Register-User', JSON.stringify(add));
            ...
            seterror("Password and Confirm Password are not Same Please Enter Same Password");
        }
                            ...
                            <div className="card-body">
                                ...
                                <form>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter your username" value={name} onChange={(e)=> setname(e.target.value)} />
                                    </div>
                                    <div className="mb-3">
                                    ...
                                    <div className="mb-3">
                                        <button type="submit" className="btn btn-primary d-grid w-100" onClick={HandleSignup}>Sign up</button>
                                    </div>
                                </form>

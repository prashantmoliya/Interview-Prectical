...
const ForgotPassword = () => {
    ...
    const HandleReset = () => {
        const reset = getregister ? getregister.find((i) => i.email === email) : null;

        if(reset){
            console.log('ForgotPassword-Post++', reset);
            ...
            localStorage.setItem('Otp-User', JSON.stringify(otp));
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <form className="mb-3">
                                    ...
                                    <button type="button" className="btn btn-primary d-grid w-100" onClick={HandleReset}>Send Reset Link</button>
                                </form>
                                <div className="text-center">
                                    <Link to="/" className="d-flex align-items-center justify-content-center x">

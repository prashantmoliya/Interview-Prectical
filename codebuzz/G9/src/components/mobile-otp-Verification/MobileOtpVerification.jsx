...
import { reqtoOtpVerification, reqtoResendOtp } from '../../redux-Toolkit/services/AuthServices';
...
const MobileOtpVerification = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (enteredOtp.length === 6) {
            ...
            let payload = { otp: enteredOtp, Mobile_number: phone };
    ...
    const handleResend = async () => {
        let payload = { type: "sms", Mobile_number: phone };

        const res = await dispatch(reqtoResendOtp(payload));
        if (res.payload?.status) {
                    ...
                    <div className="col-10 col-sm-9 col-md-7 col-lg-6 col-xl-5 col-xxl-4">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="top">
                                ...
                                <p>Enter OTP that we have send on <span>{phone}</span></p>
                            </div>
                            ...
                            <div className="second">
                                ...
                                <button
                                    type='button'
                                    className='main_btn get_otp_btn mobile'
                                    disabled
                                >

        ...
        if (user.password === user.cpassword) {
            try {
                ...
                if (res.user.accessToken) {
                    ...
                    toast.success("Your Register SuccessFull");
                }
                ...
                console.error("SignUp Error-Type Code++", err.code);        
                console.error("SignUp Error-Type Message++", err.message);
                            ...
                            <div className="card-body">
                                ...
                                <form onSubmit={HandleSignup}>
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter your username" name="name" value={user.name} onChange={HandleChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="email" className="form-label">Email</label>
                                        <input type="email" className="form-control" placeholder="Enter your email" name="email" value={user.email} onChange={HandleChange} />
                                    </div>
                                    <div className="mb-3 form-password-toggle">
                                        <label className="form-label" htmlFor="password">Password</label>
                                        <div className="input-group input-group-merge">
                                            <input type="password" className="form-control" placeholder="············" name="password" value={user.password} onChange={HandleChange} />
                                    ...
                                    <div className="mb-3 form-password-toggle">
                                        ...
                                        <div className="input-group input-group-merge">
                                            <input type="password" className="form-control" placeholder="············" name="cpassword" value={user.cpassword} onChange={HandleChange} />
                                            <span className="input-group-text cursor-pointer"><i className="bx bx-hide" /></span>
                                        </div>
                                    </div>
                                    <div className="mb-3">
                                ...
                                <p className="text-center">
                                    ...
                                    <Link to="/login" style={{ textDecoration: "none" }} className='x ms-1'>

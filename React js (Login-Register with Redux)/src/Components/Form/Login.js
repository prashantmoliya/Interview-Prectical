...
import { loginpostuser, registergetdata } from '../Redux/Rest Api/AxiosApi';

const Login = () => {

    const dispatch = useDispatch();

    const { loader, error, register } = useSelector((state) => ({
    ...
    const HandleLogin = () => {    
        try {
            ...
            const user = register?.find((i) => i.email === email && i.password === password);
            console.log("Find-Login", user);
            ...
            if(user){
                ...
                toast.error("Email and Password are not valid", {
                    position: "top-center",
                    autoClose: 3000,
                });
            }
                    ...
                    <div className="authentication-inner">
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <form>
                                    {/* <div class="alert alert-danger text-danger fw-bold" role="alert"></div> */}
                                    <div className="mb-3">
                                    ...
                                    <div className="mb-3">
                                        <button type="button" className="btn btn-primary d-grid w-100" onClick={HandleLogin}>Sign in</button>
                                        <ToastContainer />
                                    </div>
                                </form>

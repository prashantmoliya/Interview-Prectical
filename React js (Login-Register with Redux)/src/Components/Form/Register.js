...
import { registerpostdata } from '../Redux/Rest Api/AxiosApi';
    ...
    const HandleRegister = (event) => {
        ...
        try {
            if (password === cpassword) {
                ...
                toast.error("Password and Confirm Password are not same Please Enter Same Password", {
                    position: "top-center",
                    autoClose: 3000,
                });
            }
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="app-brand justify-content-center">
                                    <Link to="/Register" className="app-brand-link gap-2 x">
                                ...
                                <form>
                                    {/**message && <div class="alert alert-success text-success fw-bold" role="alert">{message}</div>}
                                    {error && <div class="alert alert-danger text-danger fw-bold" role="alert">{error}</div>**/}
                                    <div className="mb-3">
                                        <label htmlFor="username" className="form-label">Username</label>
                                        <input type="name" className="form-control" placeholder="Enter your username" value={name} onChange={(e) => setname(e.target.value)} />
                                    </div>
                                    <div className="mb-3">
                                    ...
                                    <div className="mb-3">
                                        <div className="form-check">
                                            ...
                                            <label className="form-check-label" htmlFor="terms-conditions">
                                                I agree to
                                                <Link to="javascript:void(0);" className='x ms-1'>privacy policy &amp; terms</Link>
                                            </label>
                                        </div>
                                    </div>
                                    <div className="mb-3">
                                        <button type="button" className="btn btn-primary d-grid w-100" onClick={HandleRegister}>Sign up</button>
                                        <ToastContainer />
                                    </div>
                                </form>
                                <p className="text-center">
                                    <span>Already have an account?</span>
                                    <Link to="/" className='x ms-1'>
